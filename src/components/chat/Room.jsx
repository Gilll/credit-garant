...
import CallCalling from "../icons/CallCalling";
import IconGalley from "../icons/IconGalley";
import IconDocument from "../icons/IconDocument";
import IconLink from "../icons/IconLink";
import IconTrash from "../icons/IconTrash";
import {useOutletContext, useParams} from "react-router";
import ExclamationCircleOutlined from "@ant-design/icons/lib/icons/ExclamationCircleOutlined";
import chatHostName from "../../router/chatApiConfig";
...
const Room = () => {
    ...
    useEffect(() => {
        ...
        console.log('RESIVED');
        console.log(outletState.receivedMessage);
        return () => cleanupFunction = true;
            ...
            <div className="chat__right">
                <Scrollbars autoHide className="room-list-scroll">
                    <div className="room-about">
                        <div className="room-about__icon"></div>
                        <div className="room-about__name">Служба поддержки</div>
                        <div className="room-about__actions">
                            <div className="room-about__actions-item"><Sms/></div>
                            <div className="room-about__actions-item"><CallCalling/></div>
                        </div>
                    </div>
                    <div className="room-actions">
                        <div className="room-actions__item">
                            <div className="room-actions__icon"><IconGalley/></div>
                            <div className="room-actions__text">0 фотографий</div>
                            <div className="room-actions__more">&gt;</div>
                        </div>
                        <div className="room-actions__item">
                            <div className="room-actions__icon"><IconDocument/></div>
                            <div className="room-actions__text">0 файлов</div>
                            <div className="room-actions__more">&gt;</div>
                        </div>
                        <div className="room-actions__item">
                            <div className="room-actions__icon"><IconLink/></div>
                            <div className="room-actions__text">0 ссылки</div>
                            <div className="room-actions__more">&gt;</div>
                        </div>
                    </div>
                    <div className="room-actions text-is-action">
                        <div className="room-actions__item">
                            <div className="room-actions__icon"><IconTrash/></div>
                            <div className="room-actions__text" onClick={showClearConfirm}>Очистить историю</div>
                        </div>
                        <div className="room-actions__item">
                            <div className="room-actions__icon"><IconTrash/></div>
                            <div className="room-actions__text"  onClick={showDeleteConfirm}>Удалить чат</div>
                        </div>
                    </div>
                </Scrollbars>
            </div>
